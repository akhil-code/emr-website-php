        ...
        <div class="col-lg-4 col-lg-offset-4">
          <div class="panel panel-default">
            <div align="center" class="panel-heading">
              <i class="fa fa-street-view fa-fw"></i><strong> Sign up</strong>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
              ...
              <form id="myForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                ...
                <div class="form-group input-group">
                  ...
                  <input class="form-control" id="name" placeholder="Full name (required)" type="text" name="name" required>
                </div>
                ...
                <div class="form-group input-group">
                  <span class="input-group-addon">@</span>
                  <input class="form-control" id="password" placeholder="Password (required)" type="password" name="password" required>
                </div>

                <div class="form-group input-group">
                  <span class="input-group-addon">@</span>
                  <input class="form-control" id="repeatPassword" placeholder="Repeat password" type="password" name="repeatePassword" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" id="message" name="bio"></textarea>
                </div>

                <a onclick="submitForm()" class="btn btn-success btn-block">Sign up</a>
              </form>
