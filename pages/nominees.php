...
<html>
  <head>
    ...
    <title>NIT KKR's Voting System | Nominees</title>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Nominees</a></li>
                ...
                <div class="panel-footer">
                  ...
                  <div class="list-group">
                    <div class="list-group-item">
                      ...
                      <span class="pull-right text-muted small"><em>Position &nbsp;  &nbsp;  &nbsp;</em>
        ...
        <div class="col-lg-4">
          <div class="panel panel-default">
              <div align="center" class="panel-heading">
                <i class="fa fa-street-view fa-fw"></i><strong> New Nominee</strong>
              </div>
              <!-- /.panel-heading -->
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="checkbox">
                    <label>
                      <input value="" type="checkbox"> President
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input value="" type="checkbox"> Vice President
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input value="" type="checkbox"> Secretary
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input value="" type="checkbox"> Girls Representative
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input value="" type="checkbox"> Joint Secretary
                    </label>
                  </div>
                </div>
